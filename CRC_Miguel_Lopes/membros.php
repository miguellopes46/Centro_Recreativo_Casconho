...
?>
  ...
  <div class="container mt-5 p-4">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-10 text-center text-md-left" id="tab-presidencia">
        <div class="card">
          <div class="card-header nav-tab">
            ...
            <button class="btn btn-light" data-tab-target="#suplentes">Suplente</button>
          </div>
...
$obj =$sth->FetchObject();
?>
              <img src="img/memb/<?=$obj->img?>" class="img-fluid float-sm-right mb-3 mb-md-0 rounded" alt="">
...
?>
  ...
  <div class="container mt-5 p-4">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-10 text-center text-md-left" id="tab-tesouraria">
        <div class="card">
          <div class="card-header nav-tab">
            ...
            <button class="btn btn-light" data-tab-target="#tesouraria-suplentes">Suplente</button>
          </div>
...
?>
              <img src="img/memb/<?=$obj->img?>" class="img-fluid float-sm-right mb-3 mb-md-0 rounded" alt="">
              <h5 class="card-title">Presidente: <?=$obj->nome_pessoa?></h5>
              <p class="card-text">Data de Nascimento: <?=$obj->dataN?></p>
              <p class="card-text">Sócio Nº: <?=$obj->socio?></p>
              <p class="card-text">Contacto: <?=$obj->contact?></p>
            </div>
...
?>
              <img src="img/memb/<?=$obj->img?>" class="img-fluid float-sm-right mb-3 mb-md-0 rounded" alt="">
              <h5 class="card-title">Vice-Presidente: <?=$obj->nome_pessoa?></h5>
              <p class="card-text">Data de Nascimento: <?=$obj->dataN?></p>
              <p class="card-text">Sócio Nº: <?=$obj->socio?></p>
              <p class="card-text">Contacto: <?=$obj->contact?></p>
            </div>
...
?>
              <img src="img/memb/<?=$obj->img?>" class="img-fluid float-sm-right mb-3 mb-md-0 rounded" alt="">
              <h5 class="card-title">Suplente: <?=$obj->nome_pessoa?></h5>
              <p class="card-text">Data de Nascimento: <?=$obj->dataN?></p>
              <p class="card-text">Sócio Nº: <?=$obj->socio?></p>
              <p class="card-text">Contacto: <?=$obj->contact?></p>
            </div>
  ...
  <div class="container mt-5 p-4">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-10 text-center text-md-left" id="tab-conselho-fiscal">
        <div class="card">
          <div class="card-header nav-tab">
